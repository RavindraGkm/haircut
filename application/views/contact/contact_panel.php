            ...
            <div class="logo-wrap">
                <div id="logo" class="logo small">
                    <a href="index.html" rel="home">
                        <img src="images/logo_small.png" alt="image">
                    </a>
                </div><!-- /.logo -->
            </div><!-- /.logo-wrap -->
            <div class="nav-wrap">
            ...
            <div class="roll-project gallery_regular">
                ...
                <div class="project-wrap clear-fix">
                    <div class="project-item women">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/5.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                    ...
                    <div class="project-item women men beards">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/6.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                    ...
                    <div class="project-item bleach men beards">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/7.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                    ...
                    <div class="project-item bleach men beards">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/8.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                    ...
                    <div class="project-item bleach">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/9.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                    ...
                    <div class="project-item bleach highligh">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/10.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                    ...
                    <div class="project-item bleach">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/11.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                    ...
                    <div class="project-item bleach highligh">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/12.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->

                    <div class="project-item  bleach"><?php echo base_url(); ?>assets/img/
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/13.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                    ...
                    <div class="project-item bleach">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/14.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                    ...
                    <div class="project-item bleach">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/15.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                    ...
                    <div class="project-item bleach women">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/16.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                    ...
                    <div class="project-item  bleach women">
                        <div class="item-wrap">
                            <div class="project-thumb">
                                <img src="<?php echo base_url(); ?>assets/img/images/gallery/17.jpg" alt="image">
                            </div>
                        </div><!-- /.item-wrap -->
                    </div><!-- /.project-item -->
                </div><!-- /.project-wrap -->
...
<section class="blog-information">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="info">
                    <span class="mail">hearcut_beard@info.com</span>
                    <span class="phone">8 (800) 695-2684</span>
                    <span class="address">Santa Monica Blvd, Los Angeles, Clifornia 97845, United States</span>
                </div><!-- /information -->
            </div>
        </div>
    </div>
                ...
                <div class="col-md-3">
                    <div class="widget widget-posts">
                        ...
                        <ul class="posts clearfix">
                            <li>
                                <div class="thumb">
                                    <img src="<?php echo base_url(); ?>assets/img/images/blog/6.png" alt="image">
                                </div>
                                <div class="text">
                            ...
                            <li>
                                <div class="thumb">
                                    <img src="<?php echo base_url(); ?>assets/img/images/blog/7.png" alt="image">
                                </div>
                                <div class="text">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="copyright text-center">
                    <p>© Haircuts &amp; Beards 2015 | Created with <span class="icon-heart6"></span> by <a href="#" target ="_blank">MW Templates</a></p>
                </div>
            </div><!-- /.span12 -->
        </div><!-- /.row -->
    </div><!-- /.container -->
