...
<div id="main" role="main">
    <div id="ribbon">
        <ol class="breadcrumb">
            <li>Home></li><li>Items</li><li>Add New Item</li>
        </ol>
    </div>
    <div id="content">
        <div class="row">
                        ...
                        <div>
                            <div class="widget-body no-padding col-md-12">
                                <form id="items-add" method="POST" class="smart-form" novalidate="novalidate">
                                    ...
                                    <footer>
                                        <button type="reset" class="hidden" id="reset_item_form"></button>
                                        <button type="button" class="btn btn-primary" id="btn_save_Item">
                                            Add Item
                                        </button>
                                    </footer>
                                </form>
