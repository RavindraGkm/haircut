...
<div id="main" role="main">
    <div id="ribbon">
        <ol class="breadcrumb">
            <li>Home</li><li>Quotations</li><li>All Quotations</li>
        </ol>
    </div>
    <div id="content">
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark">
                    <i class="fa fa-table fa-fw "></i>Quotations
                        <span>>
						    All Quotations
						</span>
                </h1>
                            ...
                            <div class="widget-body no-padding">
                                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th><i class="fa fa-fw text-muted hidden-md hidden-sm hidden-xs"></i>QUOTATION DATE</th>
                                        <th><i class="fa fa-fw txt-color-blue hidden-md hidden-sm hidden-xs"></i>QUOTATION TOTAL</th>
...
echo script_tag('assets/js/quotations/show_quotations.js');
?>
<script type="text/javascript">
    $(document).ready(function(){
        new CKE.ShowQuotations();
    });
</script>
</body>
</html>