                    ...
                    <div class="container">
                        <div class="row">
                            <div class="flex_caption">
                                ...
                                <p class="captionDelay2 FromTop">Anybody can cut hair off, but barber <br> knows where to stop...</p></div><!-- /.content-slider -->
                        </div><!-- /.row -->
                    </div><!-- /.container -->
                </li>
                <li class="slide2">
                    <div class="container">
                        <div class="row">
                            <div class="flex_caption">
                                ...
                                <p class="captionDelay3 FromLeft">Where you will find the cut you are <br> looking for!</p></div><!-- /.content-slider -->
                        </div><!-- /.row -->
                    </div><!-- /.container -->
                </li>
                <li class="slide3">
            ...
            <div class="roll-news">
                ...
                <div class="article">
                    <div class="item-post">
                        ...
                        <div class="content-post">
                            <h3 class="title-post"><a href="blog-single.html">oloring</a></h3>
                            <div class="entry-post">
                                <p>Qwerty</p>
                            </div>
                            <ul class="sharebar">
            ...
            <div class="row">
                ...
                <div class="col-md-3 roll-animation" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                    <div class="widget widget-tweets">
                        ...
                        <div class="list-tiwtter" data-number="2" data-username="envato" data-modpath="twitter/<?php echo base_url(); ?>home"></div>
                ...
                <div class="col-md-3 roll-animation" data-animation="fadeInRight" data-animation-delay="0" data-animation-offset="75%">
                    <div class="widget widget-subscribe">
                        ...
                        <form class="suscribe_email" id="subscribe-form" data-mailchimp="true">
                            <div id="subscribe-content">
                                <div class="input-wrap email">
                                    <input type="text" id="subscribe-email" name="subscribe-email"  class="suscribe_email" placeholder="Email Address">
                                </div>
                                <div class="button-wrap">
                                    <button type="summit" id="subscribe_button" class="subscribe-button " title="Subscribe now"> + </button>
                                </div>
                            </div>
