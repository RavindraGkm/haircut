...
<aside id="left-panel">
    <nav>
        <ul>
            ...
            <li class="active">
                <a href="#"><i class="fa fa-lg fa-fw fa-pencil-square-o"></i> <span class="menu-item-parent">All Users</span></a>
                <ul>
                    <li class="active">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                <h1 class="page-title txt-color-blueDark">
                    <i class="fa-fw fa fa fa-book"></i> &nbsp Profile
                    <span>&nbsp > &nbsp View Profile</span>
                </h1>
            </div>
        </div>
