    ...
    <nav>
        <ul>
            ...
            <li class="active">
                ...
                <ul>
                    <li class="active">
                        <?php echo anchor('billing/all-bills','<span class="menu-item-parent">View Bill</span>');?>
                    </li>
                    <li>
...
<div id="main" role="main">
    <div id="ribbon">
        <ol class="breadcrumb">
            <li>Home</li><li>Billing</li><li>All Bills</li>
        </ol>
    </div>
    <div id="content">
        <div class="row">
...
<!--                        <input type="hidden" value="--><?php //echo $bill_id; ?><!--" id="bill_id" />-->
                        <div>
                            <div class="widget-body no-padding">
                                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tr>
                                        <th>Bill No</th>
                                        <th><i class="fa fa-fw text-muted hidden-md hidden-sm hidden-xs"></i>CLIENT NAME</th>
                                        <th><i class="fa fa-fw text-muted hidden-md hidden-sm hidden-xs"></i>Bill DATE</th>
                                        <th><i class="fa fa-fw txt-color-blue hidden-md hidden-sm hidden-xs"></i>Amount</th>
                                        <th><i class="fa fa-fw txt-color-blue hidden-md hidden-sm hidden-xs"></i>ACTION</th>
                                    </tr>
                                    </thead>
...
echo script_tag('assets/js/create-bill/show_bill.js');
?>
